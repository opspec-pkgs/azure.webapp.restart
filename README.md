[![Build Status](https://github.com/opspec-pkgs/azure.webapp.restart/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/azure.webapp.restart/actions?query=workflow%3Abuild+branch%3Amain)
